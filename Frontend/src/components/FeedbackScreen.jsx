...
const FeedbackScreen = ({ lastGuess, onSubmit, onSkip }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center p-8 bg-slate-900/60 rounded-3xl border border-slate-800/60 backdrop-blur-xl">
      ...
      <form onSubmit={submit} className="w-full max-w-md space-y-4">
        <input
          ...
          className="w-full bg-slate-950/50 border border-slate-800 rounded-xl py-3 px-4 text-slate-200"
        />
