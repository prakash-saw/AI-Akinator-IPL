...
const HistoryModal = ({ user, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-slate-900 text-slate-100 rounded-2xl shadow-xl w-full max-w-3xl p-6 z-10">
        ...
        {loading ? (
          ...
          <div className="space-y-4 max-h-96 overflow-auto p-1">
            {sessions.map((s) => (
              <div key={s._id} className="p-3 bg-slate-800/60 rounded-xl border border-slate-700">
